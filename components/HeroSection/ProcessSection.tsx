...
import {Coffee, Download, Sliders, Upload} from 'lucide-react';
    ...
    return (
        <section className="w-full p-8 relative sm:mt-20 max-w-6xl">
            ...
            <div className="mx-auto">
                ...
                <div
                    className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-none lg:flex lg:items-start lg:gap-16 gap-8">
                        ...
                        >
                            ...
                            <div className="relative h-full border border-orange-500/20 rounded-lg">
                                ...
                                <div className="relative p-6">
                                    {/* 아이콘 */}
                                    <div
                                        className="w-12 h-12 rounded-full bg-[#3A2618] flex items-center justify-center mb-4">
