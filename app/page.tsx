...
export default async function HomePage({ searchParams }: PageProps) {
  // searchParams가 비동기일 수 있으므로 await 처리합니다.
        ...
        <main className="w-full min-h-screen flex flex-col md:flex-row">
          ...
          <div className="w-full md:w-1/2 p-8 md:p-8 flex flex-col items-center justify-center">
            ...
            <h1 className="font-extrabold text-4xl md:text-5xl lg:text-6xl text-white drop-shadow-lg text-center max-w-2xl">
              ...
              <span className="text-gradient bg-clip-text text-transparent bg-gradient-to-r from-orange-500 to-yellow-400 block mt-4">
                with AI Magic
              </span>
            </h1>

            {/* Free 배지 */}
            <div className="mt-8 inline-flex items-center gap-2 px-6 py-3 rounded-full bg-white/10 backdrop-blur-sm">
